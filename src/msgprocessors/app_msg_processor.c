    ...
    sandesha2_msg_ctx_t *rm_msg_ctx)
{
    ...
    if(!app_msg_ctx)
    {
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_NULL_MSG_CTX, AXIS2_FAILURE);
    ...
    if(!storage_mgr)
    {
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_COULD_NOT_CREATE_STORAGE_MANAGER, 
                AXIS2_FAILURE);
        return AXIS2_FAILURE;
    }
    ...
    if(fault_ctx)
    {
		...
		if(!axis2_engine_send_fault(engine, env, sandesha2_msg_ctx_get_msg_ctx(fault_ctx, env)))
        {
            ...
            AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_SENDING_FAULT, AXIS2_FAILURE);
            if(fault_ctx)
            {
    ...
    if(0 == msg_no)
    {
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_INVALID_MSG_NUM, AXIS2_FAILURE);
        if(seq_prop_mgr)
        {
            sandesha2_seq_property_mgr_free(seq_prop_mgr, env);
        }
    ...
    if(!next_msg_bean)
    {
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_SEQ_NOT_EXIST, AXIS2_FAILURE);
        if(seq_prop_mgr)
            sandesha2_seq_property_mgr_free(seq_prop_mgr, env);
        if(create_seq_mgr)
            sandesha2_create_seq_mgr_free(create_seq_mgr, env);
    ...
    int mep)
{
    ...
    if(!conf_ctx)
    {
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_CONF_CTX_NULL, AXIS2_FAILURE);
        return AXIS2_FAILURE;
    }
    ...
    if(!sent)
    {
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_SENDING_ACK, AXIS2_FAILURE);
    ...
    sandesha2_sender_mgr_t *sender_mgr)
{
    ...
    if(axis2_msg_ctx_get_server_side(app_msg_ctx, env))
    {
        ...
        if(!req_seq)
        {
            ...
            AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_NULL_SEQ, AXIS2_FAILURE);
            if(req_rm_msg)
            {
    ...
    sandesha2_seq_property_mgr_t *seq_prop_mgr)
{
    ...
    if(msg_num <= 0)
    {
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_INVALID_MSG_NUM, 
            AXIS2_FAILURE);
        return AXIS2_FAILURE;
    }
