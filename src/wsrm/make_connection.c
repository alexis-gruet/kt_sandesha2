    ...
    axiom_node_t *om_node)
{
    ...
    if(!identifier_element && !address_element)
    {
        AXIS2_ERROR_SET(env->error, 
        		(axutil_error_codes_t)SANDESHA2_ERROR_MAKE_CONNECTION_ELEMENT_SHOULD_HAVE_AT_LEAST_ADDRESS_OR_IDENTIFIER,
            AXIS2_FAILURE);
    ...
    void *om_node)
{
    ...
    {
        AXIS2_ERROR_SET(env->error, 
        		(axutil_error_codes_t)SANDESHA2_ERROR_INVALID_MAKE_CONNECTION_BOTH_IDENTIFER_AND_ADDRESS_NULL, AXIS2_FAILURE);
