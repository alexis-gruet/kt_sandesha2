    ...
    axiom_node_t *msg_pending_node)
{
    ...
    if(!pending_attr)
    {
        ...
        AXIS2_ERROR_SET(env->error, 
        		(axutil_error_codes_t)SANDESHA2_ERROR_PENDING_HEADER_MUST_HAVE_ATTRIBUTE_PENDING,
            AXIS2_FAILURE);
    }
    ...
    else
    {
        ...
        AXIS2_ERROR_SET(env->error, 
        		(axutil_error_codes_t)SANDESHA2_ERROR_ATTRIBUTE_PENDING_MUST_HAVE_VALUE_TRUE_OR_FALSE,
            AXIS2_FAILURE);
