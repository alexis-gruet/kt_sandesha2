    ...
    
{
    ...
    if(!property_bean)
    {
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_CONFIGURATION_NOT_SET, AXIS2_FAILURE);
    ...
    axis2_op_t *op)
{
    ...
    if(!param)
    {
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_CONFIGURATION_NOT_SET,
            AXIS2_FAILURE);
        return NULL;
    }
