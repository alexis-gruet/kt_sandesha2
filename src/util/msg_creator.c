    ...
    sandesha2_seq_property_mgr_t *seq_prop_mgr)
{
    ...
    {
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_APPLICATION_MSG_NULL, AXIS2_FAILURE);
        return NULL;
    }
    ...
    sandesha2_seq_property_mgr_t *seq_prop_mgr)
{
    ...
    if(!rm_version)
    {
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_CANNOT_FIND_RM_VERSION_OF_GIVEN_MSG, 
                AXIS2_FAILURE);
        return NULL;
    }
    ...
    sandesha2_seq_property_mgr_t *seq_prop_mgr)
{
    ...
    if(!ref_msg_ctx)
    {
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_NULL_MSG_CTX,
                AXIS2_FAILURE);
        return NULL;
    }
