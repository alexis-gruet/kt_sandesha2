...
{       
    ...
    {
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_INVALID_NS_URI, 
                        AXIS2_FAILURE);
        return NULL;                                
    }
    return NULL;
                        ...
                        axis2_char_t *rm_spec_ver)
{
    ...
    {
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_INVALID_SPEC_VERSION, 
                        AXIS2_FAILURE);
        return AXIS2_FALSE;
    }
    return AXIS2_FALSE;
        ...
        axis2_char_t *spec_version)
{
    if (0 == axutil_strcmp(SANDESHA2_SPEC_VERSION_1_0, spec_version)) 
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_UNKNOWN_SPEC_ERROR_MESSAGE, 
                AXIS2_FAILURE);
    return NULL;
}
        ...
        axis2_char_t *spec_version)
{
    if (0 == axutil_strcmp(SANDESHA2_SPEC_VERSION_1_0, spec_version)) 
    {
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_RM_SPEC_VERSION_DOES_NOT_DEFINE_A_SEQ_CLOSE_ACTION, 
                AXIS2_FAILURE);
        return NULL;
    }
    else if (0 == axutil_strcmp(SANDESHA2_SPEC_VERSION_1_1, spec_version)) 
