    ...
    axis2_char_t *sql_stmt_insert)
{
    ...
    if( rc != SQLITE_OK )
    {
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_SQL_ERROR, AXIS2_FAILURE);
    ...
    axis2_char_t *dbname)
{
    ...
    if(rc != SQLITE_OK)
    {
        ...
        AXIS2_ERROR_SET(env->error, (axutil_error_codes_t)SANDESHA2_ERROR_CANNOT_OPEN_DATABASE, AXIS2_FAILURE);
        sqlite3_close(dbconn);
        return NULL;
    }
    return dbconn;
